            ...
            while (currentStep < _steps.Count)
            {
                ...
                switch (userAction)
                {
                    ...
                    case "done":
                        ...
                        break;
                    default: // "dismissed"
                        currentStep = _steps.Count; // This will mark onboarding as complete. A better approach might be to just break and not set the complete flag. Let's stick to the simpler logic for now.
                        break;
                }
            }
